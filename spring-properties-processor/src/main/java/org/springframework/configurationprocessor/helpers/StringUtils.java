...
public abstract class StringUtils {
     ...
     * {@link #hasText(String)} (or {@code ObjectUtils#isEmpty(Object)})
     */
    @Deprecated
   ...
   /* public static String uriDecode(String source, Charset charset) {
    ...
    public static String truncate(CharSequence charSequence, int threshold) {
        if (threshold <= 0) throw new IllegalArgumentException("Truncation threshold must be a positive number: " + threshold);
